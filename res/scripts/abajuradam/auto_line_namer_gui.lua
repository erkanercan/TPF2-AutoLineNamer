...
function GUIHelper.gui_initSettingsWindow()
    ...
    local header_autoUpdate = api.gui.comp.TextView.new("Auto Update:")
    local checkBox_autoUpdate = api.gui.comp.CheckBox.new("Auto Update")
    ...
    local textInputField_autoUpdateInterval = api.gui.comp.TextInputField.new("Auto Update Interval")
    ...
    local textView_autoUpdateInterval = api.gui.comp.TextView.new("minutes")
